...
export class ServicioComponent {
  benefits = [
    ...
    { title: 'Cancelación Gratuita', description: 'Cada reserva de Dog Walk App incluye cancelación gratuita, garantizando un reembolso completo para cualquier cancelación realizada hasta 3 días antes del inicio de una reserva.', isOpen: false, icon: 'cancel', color: 'white', fontSize: '20px' },
    { title: 'Cuidadores verificados', description: 'Cada cuidador de perros de Dog Walk App ha pasado por una rigurosa evaluación y aprobación por parte de nuestro equipo.', isOpen: false, icon: 'verified', color: 'white', fontSize: '20px' },
